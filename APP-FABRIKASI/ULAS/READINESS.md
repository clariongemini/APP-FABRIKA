...
| **Operational validation** | **25** | Engine + outcome loop; N<10 decisions |
| **Effectiveness proof** | **10** | 1 outcome tagged; need 10→50→100 |
...
ULAS production-ready when:

- [ ] `ulas-player` charter passed review chain (≥2)
...
**Validate ULAS through ulas-player** — not expand ULAS.
